    ...
    Array(21).concat([
      function (t, e, n) {
        ...
        (function (t) {
          ...
          function f(t, e) {
            if (
              (c(e), (t = a(t, e < 0 ? 0 : 0 | p(e))), !s.TYPED_ARRAY_SUPPORT)
            )
      ...
      function (t, e, n) {
        ...
        var p = new a.QuillHtmlLogger(),
          d = (function () {
            function t(t, e) {
              var n = e || {},
                r = !(!n || !n.debug);
              p.setDebug(r), p.log("logging enabled");
              var o = t.getModule("toolbar");
              if (!o)
                throw new Error(
              ...
              var l = o.container,
                a = f("span");
              h(a, "class", "ql-formats");
              var d = f("button");
              (d.innerHTML = n.buttonHTML || "&lt;&gt;"),
                (d.title = n.buttonTitle || "Show HTML source"),
                (d.type = "button");
              var y = function (e) {
                t.clipboard.dangerouslyPasteHTML(e);
              };
              (d.onclick = function (e) {
                e.preventDefault(),
                  (function (t, e, n) {
                    var r = t.container.querySelector(".ql-editor").innerHTML,
                      o = f("div"),
                      l = f("div"),
                      a =
                        e.msg ||
                        'Edit HTML here, when you click "OK" the quill editor\'s contents will be replaced',
                      d = e.cancelText || "Cancel",
                      y = e.okText || "Ok",
                      v = !1 !== e.closeOnClickOverlay;
                    h(l, "class", "ql-html-overlayContainer"),
                      h(o, "class", "ql-html-popupContainer");
                    var b = f("span");
                    h(b, "class", "ql-html-popupTitle"), (b.innerText = a);
                    var g = f("div");
                    g.appendChild(b), h(g, "class", "ql-html-textContainer");
                    var m = f("pre");
                    h(m, "data-language", "xml"),
                      (m.innerText = (0, c.FormatHTMLStringIndentation)(r, p));
                    var _ = f("div");
                    h(_, "class", "ql-html-textArea");
                    var O = f("button");
                    (O.innerHTML = d), h(O, "class", "ql-html-buttonCancel");
                    var w = f("button");
                    (w.innerHTML = y), h(w, "class", "ql-html-buttonOk");
                    var x = f("div");
                    h(x, "class", "ql-html-buttonGroup");
                    var E = document.querySelector(e.prependSelector);
                    x.appendChild(O),
                      x.appendChild(w),
                      _.appendChild(m),
                      g.appendChild(_),
                      ...
                      o.appendChild(g),
                      l.appendChild(o),
                      E ? E.prepend(l) : document.body.appendChild(l);
                    var k = e && e.editorModules,
                      A = k && Object.keys(k).length ? k : {},
                      N = new s.default(_, {
                        modules: i({ syntax: e.syntax }, A)
                      });
                    (O.onclick = function () {
                      E ? E.removeChild(l) : document.body.removeChild(l);
                    }),
                      v && (l.onclick = O.onclick);
                    (o.onclick = function (t) {
                      t.preventDefault(), t.stopPropagation();
                    }),
                      (w.onclick = function () {
                        var t =
                            N.container.querySelector(".ql-editor").innerText,
                          e = (0, u.OutputHTMLParser)(t);
                        console.log("OutputHTMLParser", {
                          htmlInputFromPopup: t,
                          htmlOutputFormatted: e
                        }),
                          n(e),
                          E ? E.removeChild(l) : document.body.removeChild(l);
                      });
            ...
            return (
              (t.prototype.registerDivModule = function () {
                var t = s.default.import("blots/block"),
                  e = (function (t) {
                    function e() {
                ...
                (e.tagName = "div"),
                  ...
                  e.allowedChildren.push(t),
                  s.default.register(e);
              }),
              t
            );
          })();
        (e.htmlEditButton = d), (window.htmlEditButton = d), (e.default = d);
      },
      ,
      function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.QuillHtmlLogger = void 0);
        var r = (function () {
          function t() {
            this.debug = !1;
          }
          return (
            ...
            (t.prototype.prefixString = function () {
      ...
      function (t, e, n) {
        ...
        function h(t, e) {
          for (var n = 0; n < t.length; n++) {
            ...
            if (o) {
              ...
              for (; l < r.parts.length; l++) o.parts.push(g(r.parts[l], e));
            } else {
              var a = [];
              for (l = 0; l < r.parts.length; l++) a.push(g(r.parts[l], e));
        ...
        function v(t) {
          ...
          return (t.attrs.type = "text/css"), b(e, t.attrs), d(t, e), e;
        }
        function b(t, e) {
        ...
        function O(t, e, n, r) {
          ...
          if (t.styleSheet) t.styleSheet.cssText = _(e, o);
            ...
            l[e] && t.removeChild(l[e]),
              l.length ? t.insertBefore(i, l[e]) : t.appendChild(i);
          }
        }
        function w(t, e) {
          var n = e.css,
              ...
              return (function (t) {
                  ...
                  var r = (function () {
                    ...
                    return (
                      ...
                      (i.__isArray = function (t) {
                        return (
                          "object" == typeof t && "[object Array]" === l(t)
                        );
                      }),
                ...
                function (t, e, n) {
                  ...
                  var r,
                    ...
                    a = new i.default.Attributor.Attribute(
                      "direction",
                      "dir",
                      l
                    ),
                    ...
                    return (
                      ...
                      (f = (function (t) {
                        for (
                          ...
                          0 === t[r - 2][0] &&
                            (o = t[r - 2][1]).charCodeAt(o.length - 1) >=
                              55296 &&
                ...
                function (t, e, n) {
                  ...
                  var O = (0, c.default)("quill:clipboard"),
                    ...
                    E = [h.AlignAttribute, v.DirectionAttribute].reduce(
                      function (t, e) {
              ...
              e = Math.abs(e),
                isNaN(e) || e === 1 / 0
                  ...
                  : ((l = Math.floor(Math.log(e) / Math.LN2)),
                    ...
                    (e += l + f >= 1 ? h / s : h * Math.pow(2, 1 - f)) * s >=
                      2 && (l++, (s /= 2)),
                    l + f >= c
                      ? ((a = 0), (l = c))
                      : l + f >= 1
      ...
      function (t, e, n) {
        ...
        function o(t) {
          return t.replace(/<br([\s]*[\/]?>)/g, "<p> </p>");
        }
        function i(t) {
          return t.replace(/<p><\/p>/g, "<p> </p>");
        }
        function l(t) {
          return t.replace(/(<(?!\/)[\w=\."'\s]*>) /g, "$1");
        }
        function a(t) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.Compose =
            e.FixTagSpaceCloseTag =
            e.FixTagSpaceOpenTag =
            e.PreserveNewlinesPTags =
            e.PreserveNewlinesBr =
            e.ConvertMultipleSpacesToSingle =
            e.OutputHTMLParser =
              void 0),
          (e.OutputHTMLParser = function (t) {
            return s([r, l, a, o, i], t);
          }),
          (e.ConvertMultipleSpacesToSingle = r),
          (e.PreserveNewlinesBr = o),
          (e.PreserveNewlinesPTags = i),
          (e.FixTagSpaceOpenTag = l),
          (e.FixTagSpaceCloseTag = a),
          (e.Compose = s);
      },
      function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.FormatHTMLStringIndentation = void 0),
          (e.FormatHTMLStringIndentation = function (t, e) {
            for (
              var n = " ".repeat(2),
                r = 0,
                o = null,
              ...
              (o = i), (i = t.substr(s, 1)), (l = t.substr(s + 1, 1));
              var u = "<br>" === t.substr(s, 4),
                c = "<" === i && "/" !== l && !u,
                f = "<" === i && "/" === l && !u,
                h = ">" === o && "<" !== i && r > 0,
                p =
                  ...
                  !f &&
                  h &&
                  "" === t.substr(s, t.substr(s).indexOf("<")).trim();
              u && ((a += "\n"), r--, (s += 4)),
                c
                  ? ((a += "\n" + n.repeat(r)), r++)
                  : f
            ...
            return e.log("formatHTML", { before: t, after: a }), a;
          });
      }
    ])
  );
